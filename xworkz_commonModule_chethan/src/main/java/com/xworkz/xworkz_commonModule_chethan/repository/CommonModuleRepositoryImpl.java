...
public class CommonModuleRepositoryImpl implements CommonModuleRepository {
    ...
    public boolean onUpdate(CommonModuleEntity commonModuleEntity) {
        ...
        try {
            transaction.begin();
            Query query = entityManager.createNamedQuery("updatePasswordAndCountByEmail");
            query.setParameter("password", commonModuleEntity.getPassword());
            query.setParameter("signinCount", commonModuleEntity.getSigninCount());
    ...
    @Override
    public boolean updateDetailsByName(CommonModuleEntity commonModuleEntity) {
        EntityManager entityManager = entityManagerFactory.createEntityManager();
        EntityTransaction transaction = entityManager.getTransaction();
        try {
            transaction.begin();
